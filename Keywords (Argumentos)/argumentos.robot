...
Teste de Argumentos Opcionais
    Passando argumentos opcionais como parâmetro      nome=Lincon   ultimo_nome=Gonçalves
    Passando argumentos opcionais como parâmetro      nome=Lincon   nome_do_meio=Vinicius     ultimo_nome=Gonçalves
...
Criando lista e dicionário via parâmetro
    ...
    Teste Criando uma Lista         lincon   vinicius   gonçalves
    Teste Criando os dois           lincon   vinicius   gonçalves    shell=True    env=False
