...
Esse aqui também vai passar com uma condição e vai parar de executar as keywords abaixo!
    ${STATUS}   Run Keyword And Return Status   Should Be True    "Lincon" == "Lincon"
    Log  ${STATUS}
    Pass Execution If    ${STATUS}    message=Lincon é igual a Lincon, então passou!!

Esse keyword vai passar sozinha!
    Should Be True    "Lincon" == "Lincon"

Esse keyword vai falhar sozinha!
    Should Be True    "Lincon" == "Vinicius"
